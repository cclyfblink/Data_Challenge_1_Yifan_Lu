...
ggplot(combined_data_long, aes(x = year, y = value, color = variable)) +
    ...
    labs(x = "Year", y = "Scaled Value",
         title = "Scaled Milk Cow's Dairy Ration and Average Price of Milk Over Time",
         color = "Variable",
         caption = "Figure 5: This plot visualizes the scaled values of Milk Cow's Dairy Ration and \n Average Price of Milk from 1980 to 2014. The values are scaled for better comparison. \n The Milk Cow's Dairy Ration is colored red and the Average Price of Milk is colored blue.  \nThe x-axis represents the year, and the y-axis represents the scaled values.") + # Add a caption to the plot
    theme(plot.caption = element_text(hjust = 0.5)) + # Adjust the caption to middle
    scale_color_discrete(labels = c("Milk Cow's Dairy Ration", "Average Price of Milk")) # Add a color scale to the plot
